...
type ImportDocumentOptions struct {
	...
	FromPrefix string `arango:"fromPrefix,omitempty" json:"fromPrefix,omitempty"`
	...
	ToPrefix string `arango:"toPrefix,omitempty" json:"toPrefix,omitempty"`
	...
	Overwrite bool `arango:"overwrite,omitempty" json:"overwrite,omitempty"`
	...
	OnDuplicate ImportOnDuplicate `arango:"onDuplicate,omitempty" json:"onDuplicate,omitempty"`
	...
	Complete bool `arango:"complete,omitempty" json:"complete,omitempty"`
}
...
type ImportDocumentStatistics struct {
	...
	Created int64 `arango:"created,omitempty" json:"created,omitempty"`
	// Errors holds the number of documents that were not imported due to an error.
	Errors int64 `arango:"errors,omitempty" json:"errors,omitempty"`
