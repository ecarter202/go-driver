...
type ArangoError struct {
	HasError     bool   `arango:"error" json:"error"`
	Code         int    `arango:"code" json:"code"`
	ErrorNum     int    `arango:"errorNum" json:"errorNum"`
	ErrorMessage string `arango:"errorMessage" json:"errorMessage"`
}
